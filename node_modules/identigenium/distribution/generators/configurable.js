 ...
 */
export class ConfigurableIDProvider {
    #charSet;
    #prefix;
    #charSetLength;
    #counter = 0;
     ...
     */
    constructor(permittedCharacters, startWithCounter = 0, prefix = "") {
    ...
    *#epochUpdatingIdGenerator(startEpoch) {
